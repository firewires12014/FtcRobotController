...
@Autonomous(name = "BlueFarDump", group = "Robot")
@Disabled
public class BlueFarDump extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence rightMovementOne = drive.trajectorySequenceBuilder(startingPose)
                .lineToLinearHeading(new Pose2d(-53.25, 32, Math.toRadians(180)),
...
//                //lift to correct spot
                .UNSTABLE_addTemporalMarkerOffset(-.4, ()-> {lift.liftToHeight(200); lift.holdLift(); outtake.diffyPosition(1);})
                .UNSTABLE_addTemporalMarkerOffset(-0.3,()->{outtake.diffyPosition(5);})
                //moves to spot to release pixels
                //second drop
                .splineToConstantHeading(new Vector2d(50, 17), Math.toRadians(0),
                        Mecanum.getVelocityConstraint(DriveConstants.MAX_VEL, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        Mecanum.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
...
//                //lift to correct spot
                ...
                .splineToConstantHeading(new Vector2d(48, 17), Math.toRadians(0),
                        Mecanum.getVelocityConstraint(DriveConstants.MAX_VEL, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        Mecanum.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .lineToLinearHeading(new Pose2d(61,17 ,Math.toRadians(180)),
                        Mecanum.getVelocityConstraint(20, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        Mecanum.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                //Final Drop
                .addTemporalMarker(()->{outtake.releasePixels();})
                .waitSeconds(0.125)
                .splineToConstantHeading(new Vector2d(55, 17), Math.toRadians(180),
                        Mecanum.getVelocityConstraint(DriveConstants.MAX_VEL, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        Mecanum.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .addTemporalMarker(()->{outtake.intakePosition();})
                .build();
...
//                //lift to correct spot
                ...
                //moves to spot to release pixels
                //second drop
                .splineToConstantHeading(new Vector2d(48.5, 17), Math.toRadians(0))
                .lineToLinearHeading(new Pose2d(61, 17, Math.toRadians(180)),
                        Mecanum.getVelocityConstraint(20, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        Mecanum.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .addTemporalMarker(()->{outtake.releasePixels();})
...
//                //lift to correct spot
                ...
                .UNSTABLE_addTemporalMarkerOffset(-0.3,()->{outtake.diffyPosition(5);})
                //moves to spot to release pixels
                .splineToConstantHeading(new Vector2d(47.5, 17), Math.toRadians(0))
                .lineToLinearHeading(new Pose2d(61, 17, Math.toRadians(180)),
                        Mecanum.getVelocityConstraint(20, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        Mecanum.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                //Final Drop
...
//                //lift to correct spot
                ...
                //moves to spot to release pixels
                //second drop
                .splineToConstantHeading(new Vector2d(59, 17), Math.toRadians(0))
                .lineToLinearHeading(new Pose2d(61, 17, Math.toRadians(180)),
                        Mecanum.getVelocityConstraint(20, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        Mecanum.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .addTemporalMarker(()->{outtake.releasePixels();})
