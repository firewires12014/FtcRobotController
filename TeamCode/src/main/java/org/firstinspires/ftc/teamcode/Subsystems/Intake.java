...
primaryRoller.setPower(1);
    ...
    public void grabTwo(){intakeHeight.setPosition(0.8823);}
    public void grabTwoSpecial(){intakeHeight.setPosition(0.8867);}
 public void grabFour(){intakeHeight.setPosition(0.93587);}
    public void allUp(){
