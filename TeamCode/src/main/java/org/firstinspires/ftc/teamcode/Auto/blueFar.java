    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence leftMovementOne = drive.trajectorySequenceBuilder(startingPose)
                ...
                .lineToLinearHeading(new Pose2d(-53,13, Math.toRadians(180)),
                        Mecanum.getVelocityConstraint(5, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        Mecanum.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                ...
                .waitSeconds(0.5)
                .addTemporalMarker(()->{outtake.intakePosition(); outtake.releaseMain();})
                .waitSeconds(0.5)
        ...
        Mecanum.getVelocityConstraint(35, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                ...
                .waitSeconds(0.55)
                .addTemporalMarker(()-> {outtake.intakePosition(); lift.moveLift(0.3);})
