...
@Autonomous(name = "redFarDump", group = "Robot")

public class redFarDump extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence rightMovementOne = drive.trajectorySequenceBuilder(startingPose)
                ...
                .lineToLinearHeading(new Pose2d(-68.5, -11, Math.toRadians(180)),
                        Mecanum.getVelocityConstraint(DriveConstants.MAX_VEL, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        Mecanum.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                ...
                //puts lift down
                .UNSTABLE_addTemporalMarkerOffset(-0.85 ,()->{outtake.diffyPosition(3); intake.grabTwo();})
                ...
                //third drive across field
                .lineToLinearHeading(new Pose2d(43, -11, Math.toRadians(180)),
                        Mecanum.getVelocityConstraint(DriveConstants.MAX_VEL, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        Mecanum.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                //stop intake and lower lift
                .UNSTABLE_addTemporalMarkerOffset(-1,()->{intake.die(); lift.lowerLift();})
                //lock pixels
                .UNSTABLE_addTemporalMarkerOffset(-.75, ()-> {outtake.lockPixels(); })
                .addTemporalMarker(()-> {intake.outRoller();})
                .UNSTABLE_addTemporalMarkerOffset(.65, ()-> {intake.die();})
                //lift to correct spot
                .UNSTABLE_addTemporalMarkerOffset(-.6005, ()-> {lift.liftToHeight(210); lift.holdLift(); outtake.diffyPosition(1);})
                .UNSTABLE_addTemporalMarkerOffset(-0.5,()->{outtake.diffyPosition(5);})
                //release pixels
                .addTemporalMarker(()->{outtake.releasePixels();})
                .waitSeconds(0.05)
        ...
        TrajectorySequence middleMovementOne = drive.trajectorySequenceBuilder(startingPose)
                ...
                // go to stack
                .splineToConstantHeading(new Vector2d(-69, -10), Math.toRadians(180), //spline to stack
                        Mecanum.getVelocityConstraint(DriveConstants.MAX_VEL, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        Mecanum.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                ...
                .lineToLinearHeading(new Pose2d(20, -11, Math.toRadians(180)),
                        ...
                        Mecanum.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                // getting lift ready
                .UNSTABLE_addTemporalMarkerOffset(-1,()->{lift.liftToHeight(235); lift.holdLift(); outtake.diffyPosition(3);})
                .UNSTABLE_addTemporalMarkerOffset(-0.5,()->{outtake.diffyPosition(6);})
                //driving to backboard
                .splineToConstantHeading(new Vector2d(50, -34.5), Math.toRadians(0),
                        Mecanum.getVelocityConstraint(35, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        Mecanum.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .addTemporalMarker(()->{outtake.releasePixels();})
                .waitSeconds(0.1)
                .UNSTABLE_addTemporalMarkerOffset(.85,()->{outtake.diffyPosition(3);})
                ...
                .UNSTABLE_addTemporalMarkerOffset(.75, ()-> {intake.die();})
                //lift to correct spot
                .UNSTABLE_addTemporalMarkerOffset(-.75, ()-> {lift.liftToHeight(210); lift.holdLift(); outtake.diffyPosition(1);})
                .UNSTABLE_addTemporalMarkerOffset(-0.5,()->{outtake.diffyPosition(5);})
                //release pixels
                .addTemporalMarker(()->{outtake.releasePixels();})
                .waitSeconds(1)
