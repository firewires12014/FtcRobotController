...
@Autonomous(name = "CRIblueFar", group = "Robot")

public class CRIblueFar extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence rightMovementOne = drive.trajectorySequenceBuilder(startingPose)
                ...
                .UNSTABLE_addTemporalMarkerOffset(-1, () -> {
                    lift.liftToHeight(290);
                    lift.holdLift();
                    outtake.diffyPosition(3);
                })
                .UNSTABLE_addTemporalMarkerOffset(-.5, () -> {
                    lift.holdLift();
                    outtake.diffyPosition(0);
                })
                //spline to backboard
                .splineToConstantHeading(new Vector2d(81.75, 23), Math.toRadians(0))
                .waitSeconds(.1)
                //first drop
                .addTemporalMarker(() -> {
                    outtake.releasePixels();
                })
                ...
                .UNSTABLE_addTemporalMarkerOffset(-1, () -> {
                    lift.liftToHeight(370);
                    lift.holdLift();
                    outtake.diffyPosition(3);
                })
                .UNSTABLE_addTemporalMarkerOffset(-.5, () -> {
                    lift.holdLift();
                    outtake.diffyPosition(5);
                })
                //spline to backboard
        ...
        while (opModeIsActive()) {
            ...
            VisionBlueFar.Location location = org.firstinspires.ftc.teamcode.Vision.VisionBlueFar.Location.NOT_FOUND;
