...
@Override
    ...
    Scalar lowHSV = new Scalar(200, 0, 0); //HSV Hue Saturation Value colors looking for colors 0-250
    Scalar highHSV = new Scalar(250, 255, 255); //these are the values for green
