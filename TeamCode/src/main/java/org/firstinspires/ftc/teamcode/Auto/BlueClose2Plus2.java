...
@Autonomous(name = "BlueClose2Plus2", group = "Robot")
...
public class BlueClose2Plus2 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence leftMovementOne = drive.trajectorySequenceBuilder(startingPose)
                .lineToLinearHeading(new Pose2d(42.25, 32, Math.toRadians(180)), //purple drop
                ...
                .splineToConstantHeading(new Vector2d(-44,59), Math.toRadians(180))
                ...
                .addTemporalMarker(()->{ outtake.releasePixels();intake.die();}) //second drop
                .waitSeconds(0.15)
